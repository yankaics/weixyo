...
define('UC_DBNAME', 'weixiaoyou'); // UCenter 数据库名称
define('UC_DBCHARSET', 'utf8'); // UCenter 数据库字符集
define('UC_DBTABLEPRE', '`weixiaoyou`.uc_'); // UCenter 数据库表前缀
define('UC_DBCONNECT', '0'); // UCenter 数据库持久连接 0=关闭, 1=打开
define('UC_KEY', 'I1H5o5h2peqfv7xfP7C242gbwbTcLd64L2u8afM7k619LaM3Z2P3139dqde8GdC0'); // 与 UCenter 的通信密钥, 要与 UCenter 保持一致
define('UC_API', 'http://localhost/weixiaoyou/ucenter'); // UCenter 的 URL 地址, 在调用头像时依赖此常量
